...
import videoView.otherDemo.SurfaceVideoView;
...
//		com.ithei.andy.myapplication.VCameraDemoApplication.getInstance().addActivity(this);
		// 防止锁屏
	...
	public void onClick(View v) {
		...
		case R.id.root:
			...
			// com.ithei.andy.myapplication.VCameraDemoApplication.getInstance().exit();
			break;
		case R.id.videoview:
			if (mVideoView.isPlaying())
				mVideoView.pause();
